...
const CreateProduct = () => {
  ...
  const createItem = async () => {
    await axios
      .post("https://62286b649fd6174ca82321f1.mockapi.io/case-study/products", product)
  ...
  return (
    <div className="bg-slate-100 h-full  flex w-full max-w-[114.4rem] flex flex-col mb-[200px] mt-[50px] ml-[40%]">
      <form onSubmit={createItem}>
        <input
          className="flex w-[400px] h-[50px] rounded-xl mb-[20px] pl-[8px]"
          type="text"
        ...
        />
        <select
          className="flex w-[400px] h-[50px] rounded-xl mb-[20px] pl-[8px] pr-[8px]"
        ...
        <button type="submit" className="w-[200px] h-[50px] bg-[green] text-white rounded-xl ml-[100px]">
          Add Product
        </button>
      </form>
      <Toaster />
